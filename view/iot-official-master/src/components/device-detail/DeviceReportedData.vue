<script setup>
    ...
    const getDeviceData = async () => {
        ...
        const r1 = await http.get(`/tenant/model-data/list?tenantId=${tenantId.value}&product_key=${props.device.productDto.productKey}&deviceKey=${props.device.deviceKey}`)
